<?php
	...
	*/
	...
	$user = $_POST['user']; // take it from session
	...
	{
		$next_question_sql = "select * from prelims_questions where year='$year' and question_number=$question_number+1";
		...
		{			
			...
			echo "correct_option=".$correct_option."<br/>";
			echo "answer_description=".$answer_description."<br/>";
