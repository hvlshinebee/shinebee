...
<html lang="en">
    ...
    <body>
		...
		<div class="container-fluid">
			...
			<span style="text-align:center"><h3>By tag:  <?php echo $_GET['tag']; ?></h3></span><br/>
			...
			<?php 
				...
				$quiz_notes_sql = "select * from prelims_questions_answer where user_id='$user' and tags like '%$tag%'";
