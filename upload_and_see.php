...
<?php
		...
		if(move_uploaded_file($_FILES['photo']['tmp_name'], $targetfolder))
		{
			...
			<div class="container-fluid">
                    ...
                    <div class="row">
						...
						<div class="col-sm-9" style="border: 1px solid grey; height: 500px; overflow: scroll; border-radius:3px">
   ...
   width="100%" height="500"> </iframe>
						...
						<div class="col-sm-3" style="border: 1px solid grey; height: 500px; overflow: scroll; border-radius:3px">
							<div class="row">
								<div class="col-sm-2">
