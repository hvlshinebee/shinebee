...
if($connection === false){
    die("ERROR: Could not connect. " . mysqli_connect_error());
        ...
        $sql = "select * from question_type_pt order by question_type, question_year, question_number asc limit 1";
		$result = mysqli_query($connection, $sql);
		
		$question_type_server = "";
		$year = "";
		$question_number2 = "";
        ...
        while ($row = mysqli_fetch_assoc($result))
        {
			...
			$question_type_server = $row['question_type'];
		}
		...
		<script>
			$(document).ready(function(){
				$("#nextButton").click(function(){
					...
					question_type: document.getElementById('question_type_server').innerHTML,
					...
					$.post("pt_question_answer_questiontypewise_next.php", dataToSend, function(data)
					{
						...
						if(isNextAvailable === "true")
						{
							...
							document.getElementById("question_type").innerHTML = pasedData.question_type;
							document.getElementById("question_type_server").innerHTML = pasedData.question_type;
                ...
                <div class="container-fluid">
                    <div class="row">
						<div class="col-sm-2" style="border: 1px solid grey; height: 400px; overflow: scroll; border-radius:3px">
							...
							<?php 
								$sql_topic = "select distinct question_type from question_type_pt order by question_type";
								...
								{
									$question_type_tag = $row_topic['question_type'];
									$tag = "#topic".$question_type_tag;
									$tag2 = "topic".$question_type_tag;

									echo '<div class="row" style="margin-bottom:3px">';
									echo '<button class="btn btn-primary" type="button" data-toggle="collapse" data-target="'.$tag.'" aria-expanded="true" aria-controls="'.$tag2.'">'.$question_type_tag.'</button>';
									echo '<div class="collapse" id="'.$tag2.'">';
									
									
									$sql_question = "select * from question_type_pt where question_type = '$question_type_tag' order by id";
						...
						<h4 style="text-align:center">Question</h4>
							...
							<p id="question_type_server" hidden><?php echo $question_type_server;?></p>
							...
							Question type: <b class="float-right" id="question_type"><?php echo $question_type_server; ?></b>
							<br/>
							<hr>
